<template>
        <div class="flex flex-col items-center flex-grow">
            <table class="border-collapse border border-slate-400">
                ...
                <tr>
                    ...
                    <td class="border border-slate-300 text-center">
                        <input type="checkbox" id="expand" v-model="workoutSelectedCopy.isExpand">
                    </td>
                </tr>
                <tr>
                    <td class="border border-slate-300">Время подготовки</td>
                    <td class="border border-slate-300">
                        <input-number v-model="workoutSelectedCopy.prepareTimeS" :id="'prepare-time'"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border border-slate-300 text-center">
                        <select v-model="workoutSelectedCopy.voiceSelected">
            ...
            <table v-if="!workoutSelectedCopy.isExpand" class="border-collapse border border-slate-400 mx-auto">
                <tbody>
                <tr>
...
const props = defineProps(['workoutSelected']);
...
const workoutSelectedCopy = computed(() => ({...props.workoutSelected}));
