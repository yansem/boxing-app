...
class WorkoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'params.restBetweenPunchM' => ['exclude_if:isExpand,true', 'integer'],
            'params.restBetweenRoundsS' => ['exclude_if:isExpand,true', 'integer'],
            'params.restBetweenRoundsM' => ['exclude_if:isExpand,true', 'integer'],
            'params.*.roundCount' => ['exclude_if:isExpand,false', 'integer'],
            'params.*.roundTimeM' => ['exclude_if:isExpand,false', 'integer'],
            ...
            'params.*.restBetweenPunchM' => ['exclude_if:isExpand,false', 'integer'],
            'params.*.restBetweenRoundsS' => ['exclude_if:isExpand,false', 'integer'],
            'params.*.restBetweenRoundsM' => ['exclude_if:isExpand,false', 'integer'],
        ];
    }
}
